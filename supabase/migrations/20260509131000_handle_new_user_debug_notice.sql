-- Debug temporaneo: verificare cosa riceve Postgres su UPDATE di raw_user_meta_data.
-- Rimuovere questa migration (e il raise notice) dopo il check in produzione.
